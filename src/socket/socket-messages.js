...
module.exports = {
    ...
    processClientMessageSimple = (data) => {
        // ...
    },

    processClientMessage = (userId, data) => {
        // ...   
    },

    sendMessageToGroup = (user_id, chatGroupId, groupName, data) => {
        // ...
    },

    processFile = (name, type, size, bytes) => {
        // ...
    },

    fileSendEnded = (name, type, size) => {
        // ...
    }
